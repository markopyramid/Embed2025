...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const appStyles = {
      ...
      contextMenu: {
        ...
        menuItem: {
          ...
          icons: {
            ...
            contentDetails: "fa-solid fa-circle-info",
            ...
            modelDimension: "fa-solid fa-right-to-bracket",
            ...
            toggleMultiHighlightMode: "fa-solid fa-highlighter",
            undo: "fa-solid fa-undo",
            swap: "fa-solid fa-random",
            addToQuery: "fa-solid fa-plus",
            dice: "fa-solid fa-dice-five",
            ...
            queryOperations: "fa-solid fa-chart-column",
            sortWizard: "fa-solid fa-sort",
            sortLabelsAscending: "fa-solid fa-arrow-down-a-z",            
            ...
            copyOdataSnippetNoFilters: "fa-solid fa-code-branch",
      ...
      smartInsights: {
        background: "#f7f7f7",
        contentSection: {
          title: { font: 'bold 16px "Outfit", sans-serif', color: "#333" },
          measure: { font: 'italic 14px "Outfit", sans-serif', color: "#555" },
          value: { font: 'bold 18px "Outfit", sans-serif', color: "#000" },
        },
        icons: { logo: "url(https://example.com/logo.png)" },
      },
      present: {
        sideMenu: {
          background: "#272856",
      ...
      chatbot: {
        ...
        message: {
          ...
          userAvatar: { background: "#007bff", color: "#FFF" },
        },
        input: {
          font: '14px "Outfit", sans-serif',
          color: "#000",
